...
from .model_based_tuner import ModelBasedTuner, ModelOptimizer, DynamicModelBasedTuner
...
class DynamicXGBTuner(DynamicModelBasedTuner):
    """Tuner that uses xgboost as cost model
    ...
    def __init__(
        ...
        super(DynamicXGBTuner, self).__init__(
            task, cost_model, optimizer, plan_size, diversity_filter_ratio
        )
